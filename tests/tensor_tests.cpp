...
TEST_F(TensorTest, im2col_multi_channel_padding) {
    ...
    // Channel 1
    EXPECT_FLOAT_EQ(mat.data()[0], 0.0f); // (0,0)
    EXPECT_FLOAT_EQ(mat.data()[1], 0.0f); // (0,1)
    EXPECT_FLOAT_EQ(mat.data()[2], 0.0f); // (0,2)
    EXPECT_FLOAT_EQ(mat.data()[3], 0.0f); // (1,0)
    EXPECT_FLOAT_EQ(mat.data()[4], 1.0f); // (1,1)
    EXPECT_FLOAT_EQ(mat.data()[5], 2.0f); // (1,2)
    EXPECT_FLOAT_EQ(mat.data()[6], 0.0f); // (2,0)
    EXPECT_FLOAT_EQ(mat.data()[7], 3.0f); // (2,1)
    EXPECT_FLOAT_EQ(mat.data()[8], 4.0f); // (2,2)

    // Channel 2 (offset 9)
    EXPECT_FLOAT_EQ(mat.data()[9], 0.0f);   // (0,0)
    EXPECT_FLOAT_EQ(mat.data()[10], 0.0f);  // (0,1)
    EXPECT_FLOAT_EQ(mat.data()[11], 0.0f);  // (0,2)
    EXPECT_FLOAT_EQ(mat.data()[12], 0.0f);  // (1,0)
    EXPECT_FLOAT_EQ(mat.data()[13], -1.0f); // (1,1)
    EXPECT_FLOAT_EQ(mat.data()[14], -2.0f); // (1,2)
    EXPECT_FLOAT_EQ(mat.data()[15], 0.0f);  // (2,0)
    EXPECT_FLOAT_EQ(mat.data()[16], -3.0f); // (2,1)
    EXPECT_FLOAT_EQ(mat.data()[17], -4.0f); // (2,2)
